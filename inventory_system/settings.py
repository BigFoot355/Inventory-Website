...
SECRET_KEY = 'django-insecure-4!y@!=+mjf$l&0@vonng!+%^wuohiaoaxw8(4ro^_3r=kp(v2+'  # Para desenvolvimento; altere em produção
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Adicione diretórios de templates personalizados aqui, se necessário
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = 'Europe/Lisbon'  # Fuso horário de Portugal
